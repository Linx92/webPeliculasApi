...
namespace PeliculasAPI.Tests.PruebasUnitarias
{
    ...
    public class PeliculasControllerTests : BasePruebas
    {
        ...
        [TestMethod]
        public async Task FiltarPorTitulo()
        {
        ...
        public async Task FiltrarEnCines()
        {
            ...
            Assert.AreEqual("Película en Cines", pelicula[0].Titulo);
        }
        [TestMethod]
        public async Task FiltrarProximosEstreno() 
        {
            var nombreBD = CrearDataPrueba();
            var contexto = ConstruirContext(nombreBD);
            var mapper = ConfigurarAutoMapper();
            ...
            var pelicula = respuesta.Value;
            Assert.AreEqual(1, pelicula.Count);
            Assert.AreEqual("No estrenada", pelicula[0].Titulo);
        }
        [TestMethod]
